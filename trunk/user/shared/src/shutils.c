...
void time_zone_x_mapping()
{
	...
	if (strcmp(tmpstr, "JST") == 0)
		nvram_set("time_zone_x", "JST-9");
	else if (strcmp(tmpstr, "PRC") == 0)
		nvram_set("time_zone_x", "CST-8");
	else if (strcmp(tmpstr, "CST") == 0)
		nvram_set("time_zone_x", "CST-8");
	else if (strcmp(tmpstr, "CST-8") == 0)
		nvram_set("time_zone_x", "CST-8");
	else if (strcmp(tmpstr, "CTT") == 0)
		nvram_set("time_zone_x", "CST-8");

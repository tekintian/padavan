...
#include "common.h"
        ...
        struct variable variables_FirewallConfig[] = {
                        ...
                        {"url_filter_mode", "", NULL, EVM_RESTART_FIREWALL},
                        {"url_sinkhole_ip", "", NULL, EVM_RESTART_FIREWALL},
                        {"url_filter_whitelist", "", NULL, EVM_RESTART_FIREWALL},
                        {"url_force_dns", "", NULL, EVM_RESTART_FIREWALL},
                        {"url_parent_mac_x", "", NULL, EVM_RESTART_FIREWALL},
                        {"url_block_vpn", "", NULL, EVM_RESTART_FIREWALL},
                        {"url_block_vpn_ports", "", NULL, EVM_RESTART_FIREWALL},
                        {"url_block_doh", "", NULL, EVM_RESTART_FIREWALL},
                        {"url_log_blocked", "", NULL, EVM_RESTART_FIREWALL},

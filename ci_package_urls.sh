...
echo "wget https://github.com/tekintian/padavan/releases/download/toolchain/mipsel-linux-musl.tar.xz"
...
echo "# 或使用 curl 下载"
echo "cd ${LOCAL_FILES_DIR}"
echo "curl -L -O https://github.com/tekintian/padavan/releases/download/toolchain/mipsel-linux-musl.tar.xz"
